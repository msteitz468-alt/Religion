...
def test_figure_pages_yaml():
    ...
    required_fields = ["title:", "also_known_as:", "tradition:", "textual_sources:", "roles:"]
    ...
    print("All figure pages have required YAML frontmatter.")
    sys.exit(0)

if __name__ == "__main__":
    test_figure_pages_yaml()
