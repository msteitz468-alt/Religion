...
The foundational teaching of [[buddhism|Buddhism]], delivered in the [[gautama-buddha|Buddha's]] first
sermon and shared by every Buddhist school:
...
This is the diagnostic structure of the whole tradition — a "physician's" analysis (disease, cause,
cure, treatment). It presupposes **dependent origination** (suffering arises from conditions and so
can be unconditioned) and is realized fully in [[anatta|non-self]]. The [[mahayana|Mahayana]]
...
The non-theistic framing — liberation by insight, no savior deity — is the sharpest structural contrast
with the Abrahamic soteriologies ([[justification|justification]], grace) and with the Hindu
*moksha*-through-*atman* path that [[anatta|non-self]] explicitly rejects.
