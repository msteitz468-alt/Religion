...
**Theōsis** ("deification," "divinization") is the doctrine — central to Eastern Orthodox theology —
that the goal of salvation is the believer's transforming participation in the life of God; in
Athanasius's famous formula, "God became man so that man might become god." Its single most important
biblical anchor is **2 Peter 1:4**, the only NT text that speaks of believers becoming "**partakers of
the divine nature**" (*theias koinōnoi physeōs*). The verse is therefore a key site where exegesis and
the doctrine of salvation meet, and where the traditions diverge.

## The Text (2 Peter 1:3–4)

God's "divine power has granted us all things for life and godliness," and he has given "precious and
very great promises, so that through them you may become **partakers of the divine nature**, having
escaped the corruption that is in the world because of sinful desire." The grammar (a Hellenistic
"honorific decree" form) ties the promised participation to a purpose: a transformed life that escapes
moral corruption.

## The Interpretive Question

What does "partakers of the divine nature" mean? The options span a spectrum:
- **Ontological deification** — believers come to share in God's very being/essence (a strong reading
  congenial to Eastern *theōsis*, though Orthodoxy itself distinguishes God's unknowable *essence*
  from his *energies*, in which believers participate).
- **Immortality/incorruption** — sharing God's imperishable nature, i.e., eternal life (Bauckham).
- **Moral transformation** — sharing God's *moral character* (virtue), becoming like God ethically.

## Green's Reading: Moral Transformation, Not Divinization

[[gene-green|Gene L. Green]] (BECNT 2 Peter, 2008) argues for the **moral** reading. Setting 1:4
against its Greco-Roman and Hellenistic-Jewish background (Dio Chrysostom, Diodorus, Josephus, Philo,
Plutarch, the Stoics — and J. M. Starr's comparative study), Green concludes:
- The ancient discussion was *not* about humans becoming divine in essence, but about **which
  characteristics** the classes of beings (gods, humans, animals) share. Josephus uses nearly
  identical language (*theias… physeōs*) for sharing divine *characteristics*; Philo can speak of
  imitating "the divine nature" as a matter of virtue.
- Peter's point "has to do with **moral transformation and not divinization** or becoming divine men,"
  and is "not principally about becoming 'immortal and incorruptible'" (against Bauckham) but about
  the **acquisition of moral character**.
- The context confirms it: the very next clause is "having escaped the **corruption**… because of
  sinful desire" (1:4b), and 1:5–7 spells out the resulting **virtues** (the "ladder": faith →
  virtue → knowledge → self-control → endurance → godliness → brotherly affection → love).
- Danker's framing (which Green adopts): to share the divine nature is "to participate in the supreme
  virtues of the Chief Benefactor," especially righteousness — *human virtue coming to resemble
  God's*.
...
- **Eastern Orthodox**: *theōsis* is the architecture of salvation; 2 Pet. 1:4 (with John 17, Gal.
  2:20, 2 Cor. 3:18) is its charter. Participation is in God's *energies*, not his *essence* (Gregory
  Palamas) — which keeps deification from collapsing Creator and creature.
- **Roman Catholic**: a real participation in the divine life by grace ("the divinization of the
  human person"), closely tied to sanctifying grace and the beatific vision.
- **Protestant**: traditionally cautious, often reading 1:4 (with Green) as moral renewal /
  Christlikeness / sanctification rather than ontological deification — though a "Reformed" or
  "Finnish Lutheran" recovery of *theōsis*/union-with-Christ language has grown. Compare
  [[justification|Justification]] (forensic) and Calvin's *union with Christ* / "double grace."

## Connections in the Wiki

The moral-transformation reading aligns 2 Pet. 1:4 with the NT's broader **union-with-Christ and
sanctification** themes rather than with a distinct metaphysics: the believer is conformed to God's
character. It contrasts instructively with the **forensic** emphasis of [[justification|Justification]]
...
- [[gene-green|Gene L. Green]] — source; the moral-transformation reading
